 ...
 * their inventory along with an option to view the entire list of products sold or search by
...
int display_sold_products(struct SELLER *seller)
{
    ...
    {
        printf("\n\n---------------------No sold products for this seller---------------------------\n\n");
    ...
    if(option == 2)
    {
        ...
        {
            printf("\n");
            printf("%-20s %-30s %-20s   %-20d       %-30d",
                   sold_products->buyer_name,
                   sold_products->buyer_shipping_address,
                   sold_products->phone_number,
                   sold_products->product_number,
    ...
    {
        /*if sort by product number defined as pnum */
        int pnum;
        ...
        {
            printf("\n\n-----------------------There is no product with the product number as: %d ---------------------\n\n", pnum);
